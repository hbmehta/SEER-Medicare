...
data comp_eff.Pdesaf_rx;				* 2188968;
...
run;
proc sort data=comp_eff.redbook out=redbook; by generic brand; run;
...
%macro rb (out_file_1, out_file_2, string, med);
	...
	proc sql;							
		create table comp_eff.&out_file_2 as
		select a.ndc, b.prod_srvc_id, b.patient_id, 1 as &med
		from &out_file_1 as a, comp_eff.Pdesaf_rx as b
		where a.ndc = b.prod_srvc_id;
	quit;
	
	data comp_eff.&out_file_2;
		set comp_eff.&out_file_2;
		keep patient_id &med;
	run;

	proc sort data = comp_eff.&out_file_2 out = comp_eff.&out_file_2 nodup; by patient_id; run;
...
data comp_eff.covariate_13;

	merge comp_eff.covariate_12(in=in1) comp_eff.Ndc_acei; by patient_id; if in1;

	merge comp_eff.covariate_12(in=in1) comp_eff.Ndc_arb; by patient_id; if in1;

	merge comp_eff.covariate_12(in=in1) comp_eff.ndc_av; by patient_id; if in1;

	merge comp_eff.covariate_12(in=in1) comp_eff.ndc_antiarrhythmics; by patient_id; if in1;

	merge comp_eff.covariate_12(in=in1) comp_eff.ndc_antiplatelets; by patient_id; if in1;

	merge comp_eff.covariate_12(in=in1) comp_eff.ndc_aspirin; by patient_id; if in1;

	merge comp_eff.covariate_12(in=in1) comp_eff.ndc_bb; by patient_id; if in1;

	merge comp_eff.covariate_12(in=in1) comp_eff.ndc_ccb; by patient_id; if in1;

	merge comp_eff.covariate_12(in=in1) comp_eff.ndc_diuretics; by patient_id; if in1;

	merge comp_eff.covariate_12(in=in1) comp_eff.ndc_oa; by patient_id; if in1;

	merge comp_eff.covariate_12(in=in1) comp_eff.ndc_dd; by patient_id; if in1;

	merge comp_eff.covariate_12(in=in1) comp_eff.ndc_estrogens; by patient_id;
	if in1;

	merge comp_eff.covariate_12(in=in1) comp_eff.ndc_progestins; by patient_id; if in1;

	merge comp_eff.covariate_12(in=in1) comp_eff.ndc_hlmwh; by patient_id; if in1;

	merge comp_eff.covariate_12(in=in1) comp_eff.ndc_naid; by patient_id; if in1;

	merge comp_eff.covariate_12(in=in1) comp_eff.ndc_statins; by patient_id; if in1;

	merge comp_eff.covariate_12(in=in1) comp_eff.ndc_nlld; by patient_id; if in1;
	
	merge comp_eff.covariate_12(in=in1) comp_eff.ndc_ppi; by patient_id; if in1;
